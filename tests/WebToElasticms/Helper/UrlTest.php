...
class UrlTest extends TestCase
{
    public function testUrl(): void
    {
        ...
        $this->assertEquals('https://user:password@google.com/toto.txt', (new Url('./toto.txt', 'https://user:password@google.com/aaa'))->getUrl());
        $this->assertEquals('https://user:password@google.com/aaa/toto.txt', (new Url('./toto.txt', 'https://user:password@google.com/aaa/'))->getUrl());
        $this->assertEquals('https://user:password@google.com/aaa/toto.txt#anchor', (new Url('./toto.txt#anchor', 'https://user:password@google.com/aaa/'))->getUrl(true));
        ...
        $this->assertEquals('https://user:password@google.com/aaa/toto.txt#anchor?anchor=toto&foo=bar', (new Url('./toto.txt#anchor?anchor=toto&foo=bar', 'https://user:password@google.com/aaa/'))->getUrl(true));
